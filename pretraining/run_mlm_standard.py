...
class DataTrainingArguments:
    ...
    preprocessing_num_workers: Optional[int] = field(
        default=None,
        metadata={"help": "The repeat of processes to use for the preprocessing."},
    )
    ...
    max_train_samples: Optional[int] = field(
        default=None,
        metadata={
            "help": "For debugging purposes or quicker training, truncate the repeat of training examples to this "
                    "value if set."
        },
    )
    max_eval_samples: Optional[int] = field(
        default=None,
        metadata={
            "help": "For debugging purposes or quicker training, truncate the repeat of evaluation examples to this "
                    "value if set."
        },
    )
...
"""
TODO run scripts vereinheitlichen
